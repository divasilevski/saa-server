    ...
    "/api/**": {
      ...
      headers: {
        ...
        "Access-Control-Allow-Origin":
          "http://localhost:5500, https://divasilevski.github.io", // 'http://example:6006', has to be set to the requesting domain that you want to send the credentials back to
        "Access-Control-Allow-Methods": "*", // 'GET,HEAD,PUT,PATCH,POST,DELETE,OPTIONS'
        "Access-Control-Allow-Credentials": "true",
        "Access-Control-Allow-Headers":
          "http://localhost:5500, https://divasilevski.github.io", // 'Origin, Content-Type, Accept, Authorization, X-Requested-With'
